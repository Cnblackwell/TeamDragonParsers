...
def ArrestsByYear = "annual_police_report:hello_world"
ArrestsByAge = "annual_police_report:cool_beans"
ArrestsCohort = "annual_police_report:tong"
LinearRegression = "annual_police_report:tong2" 