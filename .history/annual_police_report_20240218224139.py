...
class TeamDragonParsers:
    ...
    def arrest_by_age_year(self, data, years):
        ...
        plt.bar(r1, data['adult'], color=['plot_colour1'], width=barWidth, edgecolor='white', label='Adult')
        plt.bar(r2, data['youth'], color=['plot_colour2'], width=barWidth, edgecolor='white', label='Youth')
    ...
    def linear_regression(self, annual_police_report):
        ...
        plt.scatter(annual_police_report['arrest_year'], annual_police_report['arrest_count'], color=['plot_colour1'], label='Data Points')
        ...
        '''
        plt.plot(annual_police_report['arrest_year'], model.predict(annual_police_report[['arrest_year']]), color=['plot_colour2'], label='Regression Line')
...
def hello_world():
    print("This code is working successfully")
def cool_beans():
    print("Simeon and Tong made us do this.")
