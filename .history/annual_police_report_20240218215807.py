...
def hello_world():
    print("Arrests by Year uploaded to the local folder")

def cool_beans():
    print("Simeon, this is for you!")

def tong():
    print("This was a fun assignment.")

def tong2():
    print("Visualizations saved in your local folder.")    
